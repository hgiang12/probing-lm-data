...
class ActDataset:
    ...
    def collect_acts(
        ...
        acts = [
            ...
            for i in range(0, batch_size * len(activation_files), batch_size)
        ]
...
def parse_args():
    ...
    parser.add_argument("--plm_dir", type=str, default="")
...
if __name__ == "__main__":
    ...
    if "blip-image-captioning-large" in args.target_model:
        layer_num = 24
    elif "blip-image-captioning-base" in args.target_model:
        layer_num = 12
    elif "blip-vqa-base" in args.target_model:
        layer_num = 12
    else:
